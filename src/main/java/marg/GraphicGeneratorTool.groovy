...
import marg.commands.VisualizerCommand;
import marg.view.FormatterType;
import org.semanticweb.HermiT.Configuration;
...
public class GraphicGeneratorTool {
     ...
     * @param reasoners List of reasoners that will be used during the inference process.
     ...
     * @param equivalentClasses Equivalent classes flag.
    ...
    public static void runGraphGenerator(List<OWLReasoner> reasoners, OWLOntology ontology, Set<FormatterType> setFormatterType,
        ...
        System.out.println("Formatter:"+setFormatterType.toString());
        ...
        if((pathOntology!=null)&&(!pathOntology.isEmpty())){
            ...
            if(owlFile.exists()) {
                try {
                    ...
                    System.out.println("Ontology not loaded");
                }
            }
        }
        return(ontology);
     ...
     * -eq This option will activate the equivalent classes flag
     * -op This option will contain a set of object properties defined on the ontology.
     * -t This option will activate the Transitive reduction flag
     * -nt This option will contain the number of threads that will be used during the inference process.
    ...
    public static Options buildCommandLineOptions(){
        ...
        String outputPathDescription = "This parameter represents the output path where the files generated by the tool will be saved.";
        ...
        String reasoner = "r";
        String reasonerDescription = "The reasoner will be used (ELK[DEFAULT],HERMIT,STRUCTURAL_REASONER, SYNTACTIC_REASONER).";
        ...
        String format = "f";
        String formatDescription = "The different visualization formats available (JSONLD, RDFXML, GRAPHVIZ[DEFAULT], OBOFLATFILE,GRAPHML).\n"+
        ...
        String equivalentClassesDescription = "This is a boolean parameter, if it is false only representative classes will be taken to build the final graph\n"+
                                               "but if it is true representative classes and equivalent classes will be taken (TRUE, FALSE[DEFAULT]) ";
        ...
        String transitive = "t";
        String transitiveDescription ="This parameter will contain a boolean (TRUE,FALSE[DEFAULT]) that specifies whether the transitivity reduction is applied over the selected object properties \n";
        ...
        String nThreads = "nt";
        String nThreadsDescription = "This parameter represents the number of the threads that the application is going to use (4[DEFAULT]).";
     ...
     * @return The message that contains a little description of the  parameters that are needed to execute the application.
     */
    public static String getManual(){
        StringBuilder builder = new StringBuilder();
        builder.append("These are the parameters that should be provided: \n");
        builder.append("-ont This parameter will contain the ontology file or at least the path where the ontology is located. \n");
        builder.append("-out This parameter represents the output path where the files generated by the tool will be saved. \n");
        builder.append("-r The reasoner will be used during the inference process (ELK[DEFAULT],HERMIT,STRUCTURAL_REASONER, SYNTACTIC_REASONER). \n");
        builder.append("-f The different visualization formats available (JSONLD, RDFXML, GRAPHVIZ[DEFAULT], OBOFLATFILE, GRAPHML). \n");
        builder.append("\tIn order to generate all formats available just provide [\"*\"]. \n");
        builder.append("-eq This parameter will contain a boolean (TRUE,FALSE[DEFAULT]) that specifies whether or not only the representative classes will be taken.");
        ...
        builder.append("-t This parameter will contain a boolean (TRUE,FALSE[DEFAULT]) that specifies whether the transitive reduction is applied over the selected object properties.");
        builder.append("-nt This parameter represents the number of the threads that the application is going to use (4[Default]). \n");
        return(builder.toString());
    }

    /**
     * The main of the application. It aims to iniciate the parameters passed through command line and then the
